...
import com.zsy.frame.lib.image.imageloader.core.assist.FailReason.FailType;
import com.zsy.frame.lib.image.imageloader.core.decode.ImageDecoder;
import com.zsy.frame.lib.image.imageloader.core.decode.ImageDecodingInfo;
import com.zsy.frame.lib.image.imageloader.core.download.ImageDownloader;
import com.zsy.frame.lib.image.imageloader.core.download.ImageDownloader.Scheme;
 ...
 * display it in {@link com.zsy.frame.lib.image.imageloader.core.imageaware.ImageAware} using {@link DisplayBitmapTask}.
 *
...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	private void checkViewCollected() throws TaskCancelledException {
		if (isViewCollected()) { throw new TaskCancelledException(); }
	}
	...
	private void checkViewReused() throws TaskCancelledException {
		if (isViewReused()) { throw new TaskCancelledException(); }
	}
