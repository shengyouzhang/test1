...
import com.zsy.frame.lib.image.imageloader.core.assist.LoadedFrom;
import com.zsy.frame.lib.image.imageloader.core.assist.ViewScaleType;
import com.zsy.frame.lib.image.imageloader.core.imageaware.ImageAware;
import com.zsy.frame.lib.image.imageloader.core.imageaware.ImageViewAware;
import com.zsy.frame.lib.image.imageloader.core.imageaware.NonViewAware;
...
import com.zsy.frame.lib.image.imageloader.utils.ImageSizeUtils;
...
public class ImageLoader {
	 ...
	 * @param imageAware {@linkplain com.zsy.frame.lib.image.imageloader.core.imageaware.ImageAware Image aware view}
	 ...
	 * @param imageAware {@linkplain com.zsy.frame.lib.image.imageloader.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.zsy.frame.lib.image.imageloader.core.DisplayImageOptions Options} for image
	 ...
	 * @param progressListener {@linkplain com.zsy.frame.lib.image.imageloader.core.listener.ImageLoadingProgressListener
	 *                         Listener} for image loading progress. Listener fires events on UI thread if this method
	 *                         is called on UI thread. Caching on disk should be enabled in
	 *                         {@linkplain com.zsy.frame.lib.image.imageloader.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	 ...
	 * {@link com.zsy.frame.lib.image.imageloader.core.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * {@link com.zsy.frame.lib.image.imageloader.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware {@link com.zsy.frame.lib.image.imageloader.core.imageaware.ImageAware ImageAware} for
	 ...
	 * {@linkplain com.zsy.frame.lib.image.imageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
