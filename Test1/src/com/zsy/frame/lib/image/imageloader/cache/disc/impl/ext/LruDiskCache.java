 ...
 *******************************************************************************/
package com.zsy.frame.lib.image.imageloader.cache.disc.impl.ext;
...
import com.zsy.frame.lib.image.imageloader.utils.IoUtils;
 ...
 * {@link com.zsy.frame.lib.image.imageloader.cache.disc.impl.ext.DiskLruCache DiskLruCache} to
 * {@link com.zsy.frame.lib.image.imageloader.cache.disc.DiskCache DiskCache}
 *
...
public class LruDiskCache implements DiskCache {
	 ...
	 * @param fileNameGenerator {@linkplain com.zsy.frame.lib.image.imageloader.cache.disc.naming.FileNameGenerator
	...
	public LruDiskCache(File cacheDir, File reserveCacheDir, FileNameGenerator fileNameGenerator, long cacheMaxSize, int cacheMaxFileCount) throws IOException {
		if (cacheDir == null) { throw new IllegalArgumentException("cacheDir" + ERROR_ARG_NULL); }
		if (cacheMaxSize < 0) { throw new IllegalArgumentException("cacheMaxSize" + ERROR_ARG_NEGATIVE); }
		if (cacheMaxFileCount < 0) { throw new IllegalArgumentException("cacheMaxFileCount" + ERROR_ARG_NEGATIVE); }
		if (fileNameGenerator == null) { throw new IllegalArgumentException("fileNameGenerator" + ERROR_ARG_NULL); }
	...
	private void initCache(File cacheDir, File reserveCacheDir, long cacheMaxSize, int cacheMaxFileCount) throws IOException {
		try {
			...
			if (cache == null) { throw e; // new RuntimeException("Can't initialize disk cache", e);
			}
		}
	}
