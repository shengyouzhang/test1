 ...
 *******************************************************************************/
package com.zsy.frame.lib.image.imageloader.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;

import com.zsy.frame.lib.image.imageloader.cache.disc.DiskCache;
import com.zsy.frame.lib.image.imageloader.cache.disc.naming.FileNameGenerator;
import com.zsy.frame.lib.image.imageloader.cache.memory.MemoryCache;
import com.zsy.frame.lib.image.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.zsy.frame.lib.image.imageloader.core.assist.FlushedInputStream;
...
import com.zsy.frame.lib.image.imageloader.core.decode.ImageDecoder;
import com.zsy.frame.lib.image.imageloader.core.download.ImageDownloader;
import com.zsy.frame.lib.image.imageloader.core.process.BitmapProcessor;
import com.zsy.frame.lib.image.imageloader.utils.L;
import com.zsy.frame.lib.image.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.zsy.frame.lib.image.imageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.zsy.frame.lib.image.imageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.zsy.frame.lib.image.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		...
		public Builder memoryCacheSizePercentage(int availableMemoryPercent) {
			if (availableMemoryPercent <= 0 || availableMemoryPercent >= 100) { throw new IllegalArgumentException("availableMemoryPercent must be in range (0 < % < 100)"); }
		 ...
		 * Default value - {@link com.zsy.frame.lib.image.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.zsy.frame.lib.image.imageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.zsy.frame.lib.image.imageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.zsy.frame.lib.image.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.zsy.frame.lib.image.imageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.zsy.frame.lib.image.imageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.zsy.frame.lib.image.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.zsy.frame.lib.image.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.zsy.frame.lib.image.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.zsy.frame.lib.image.imageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.zsy.frame.lib.image.imageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
