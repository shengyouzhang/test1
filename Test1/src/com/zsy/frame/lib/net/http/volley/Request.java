...
public abstract class Request<T> implements Comparable<Request<T>> {
	...
	public final int getSequence() {
		if (mSequence == null) { throw new IllegalStateException("getSequence called before setSequence"); }
		return mSequence;
	}
	...
	public byte[] getPostBody() throws AuthFailureError {
		...
		if (postParams != null && postParams.size() > 0) { return encodeParameters(postParams, getPostParamsEncoding()); }
		return null;
	}
	...
	public byte[] getBody() throws AuthFailureError {
		...
		if (params != null && params.size() > 0) { return encodeParameters(params, getParamsEncoding()); }
		return null;
	}
