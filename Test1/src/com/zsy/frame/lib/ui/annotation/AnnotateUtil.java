package com.zsy.frame.lib.ui.annotation;
...
/**
 * @description：注解工具类,目前只能通过设置OnClick事件处理
 * @author samy
 * @date 2015-1-22 下午10:10:47
 */
public class AnnotateUtil {
	...
	public static void initBindView(View view) {
		...
		if (cxt instanceof Activity) {
			...
			throw new SYException("the view don't have root view");
		}
	}
